<template>
	<h1>海纳百川</h1>
	<p>曹操很早就意识到，要想成就一番霸业，人才是关键，所以曹操曾连续三次颁布求贤令，提出了“唯才是举”的口号，这个惊世骇俗的举动几乎颠覆了当时人们传统用人观。那么，我们该怎样理解曹操的“唯才是举”呢？敬请关注《易中天品三国之海纳百川》。
	</p>
	<p>
	...
	<p>“绍凭世资，从容饰智，以收名誉，故士之寡能好问者多归之。”</p>
	<p>
	...
	<p>曹操的做法刚好相反，曹操的做法是什么呢？我们也可以总结十六个字：实事求是、唯才是举、不拘一格、来者不拒。也就是说曹操他是实实在在地希望有很多的人才来帮助他，在此前提下，曹操妥善地处理了五种关系。</p>
	<p>曹操的用人政策一： 名至实归　更重实际</p>
	<p>
	...
	<p>曹操是这样的一个人，所以他在处理人才的问题上他的态度就是名至实归、更重实际。</p>
	<p>曹操的用人政策二： 德才兼备　唯才是举</p>
	<p>
	...
	<p>所以曹操三次颁布求贤令，甚至提出这样一个说法，就是只要是一个人才，哪怕不仁不孝，你们都尽管推荐给我。所以曹操在处理德才关系的时候他的做法是：德才兼备、唯才是举。</p>
	<p>
