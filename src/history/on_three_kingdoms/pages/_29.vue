<template>
	<h1>命案真相</h1>
	<p>崔琰是三国时代一位非常值得敬重的名士，曹操对他的一身正气都颇有忌惮，而崔琰却因为一封信被曹操冤杀。</p>
	<p>杨修则是出身名门，博学多才，多次在曹操面前展示聪明才智，却因一个莫名其妙的罪名被曹操所杀。</p>
	<p>那么曹操为什么要杀崔琰和杨修呢？他们究竟触动了曹操哪根敏感的神经？敬请关注《易中天品三国》之——命案真相。</p>
	<p>从前面两集讲到的荀彧之死和孔融之死可以看出，曹操决不允许别人在政治上和他作对，尤其是不能允许公开作对。但是，在此之后，曹操又杀死了不曾与他作对的崔琰和杨修，这更是为曹操留下了“无端杀人”的千古罪名。</p>
	<p>
	...
	<p>那么崔琰的死为什么是冤案？那我们就要讲两个问题：第一，崔琰是一个什么样的人；第二，崔琰是怎么死的。</p>
	<p>
	...
	<p>而且崔琰在选拔这些干部的时候完全是出于公心，唯才是举，而且要求德才兼备，一直受到朝廷上下的一片称赞。而曹操也明确地表示，崔琰这个人作风非常正派，他本身就是一个表率，他可以使贪婪的人变得清廉，使勇敢的人更加激励，是这样的一个人。
	</p>
	<p>
	...
	<p>＊ 通过易中天先生的分析，崔琰是一个光明磊落、一身正气的人，曹操对崔琰也是非常敬畏的。然而，在公元216年，崔琰被曹操杀死。那么曹操为什么要杀死崔琰呢？崔琰之死究竟冤在何处呢？</p>
	<p>＊ 易中天先生刚才讲到，崔琰是这样一位道德高尚的人，这样一位一身正气的人，他为什么会惹怒曹操呢？据史书记载，崔琰因为牵扯一个蹊跷的文字狱案件被曹操杀死。聪明一世的曹操又为什么会用文字狱来加害崔琰呢？崔琰之死究竟冤在何处呢？</p>
	<p>
	...
	<p>而且我们知道崔琰和杨修是在曹操的最后的岁月里被杀的，而这个时候曹魏集团内部的斗争异常激烈，因为曹操的几个儿子都在争夺接班人的地位，那么他们是怎么争夺的？最后又花落谁家呢？请看下集——夺嫡之争。</p>
