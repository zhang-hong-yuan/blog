<template>
	<h1>败走麦城</h1>
	<p>这是一个侠义英雄的结束。建安二十四年，关羽被杀，刘备集团不但痛失一员猛将，还永远地失去了荆州。那么，一个曾经威震华夏的虎将，为什么会一败涂地？在刘备方面，谁该为关羽的死负责呢？厦门大学易中天教授为您精彩品三国之——败走麦城。
	</p>
	<p>在上一期节目中易中天先生讲到，由于曹操和孙权两个集团暗中勾结，使关羽处于一个非常困难的境地，关羽只好从襄樊前线撤退，败走麦城。结果是关于被俘，然后被杀。</p>
	<p>关羽之死，给后世留下了无数的遗憾。一个曾经是一等一的英雄，最终却是这样的下场。那么，在刘备集团当中，到底谁该为关羽的死负责任？刘备和诸葛亮对关羽的死有没有责任？厦门大学易中天教授做客《百家讲坛》，为您精彩品三国之“败走麦城”。
	</p>
	<p>我们知道，丢失荆州、关羽阵亡的前因是关羽攻打襄樊。如果关羽不攻打襄樊，那么吕蒙和孙权虽然早就有了夺回荆州、消灭关羽的这个想法，他是没有机会实施的。因此，我们要检讨的第一个问题就是：为什么要发动襄樊战争？我们先得把这个问题弄清楚。
	</p>
	<p>而这个问题呢，又牵扯到三个小问题。第一个问题是，谁决定打襄樊？</p>
	<p>
	...
	<p>第二个小问题，为什么要打襄樊？</p>
	<p>这个问题史学界也有两种不同的意见。吕思勉先生的观点是认为这是配合刘备在汉中的行动。吕先生说：“逐利之兵，亦宜同时并出，首尾相应。故刘备之兵未还，关羽之师已起矣。”
		因为刘备在打汉中，所以关羽这边配合行动打襄樊，牵制曹操。这个说法呢，我有点疑问。所以我比较倾向于赞同另一种观点，那就是得寸进尺。刘备在汉中取得了胜利，称了汉中王，关羽当了前将军，这时候刘备集团觉得自己很了不得，那么再干一下。那汉中你看也没怎么打，曹操不也就走了吗？曹操也没那么可怕嘛，也没那么恐惧嘛。所以，关羽的这个得寸进尺，我们从好的方面、从肯定的方面讲，叫做乘胜前进、再接再厉；那说得不好听呢，就叫贪得无厌、自不量力。
	</p>
	<p>那么究竟是乘胜前进、再接再厉，还是贪得无厌、自不量力呢？我们就要回答下面一个小问题，就是该不该打襄樊？这个问题学术界又有两种相反的意见。</p>
	<p>
