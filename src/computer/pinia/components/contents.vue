...
nav.contents {
	...
	box-shadow: 15px 3px 10px 3000px rgba(0, 0, 0, 0.2), 15px 2px 35px rgba(0, 0, 0, 0.14), 25px 1px 23px rgba(0, 0, 0, 0.12);
			...
			a {
				...
				&.routeActive {
					...
					&::before {
						...
						height: 30px;
						content: '';
						background-image: url(../assets/logo_pinia.svg);
